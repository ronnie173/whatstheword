...
public class ClickableToast extends FrameLayout {
    ...
    private DismissToastBroadcastReceiver dismissReceiver = new DismissToastBroadcastReceiver();
    ...
    public void show(){
        ...
        try{
        	...
        	// In case the view was already added
        	e.printStackTrace();
        }
    ...
    public static class DismissToastBroadcastReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            if(toast != null && toast.hideOnClose){
                toast.hide();
            }
        }
    };
