...
public class APIResponseHandler extends com.heyzap.http.JsonHttpResponseHandler {
    ...
    public APIResponseHandler setLoadingText(Context context, String loadingText){
        try {
            loadingDialog = HeyzapProgressDialog.show(context, "", loadingText, true, true);
        } catch(Throwable e) {}

        return this;
    }

    public APIResponseHandler setNotifyOnError(boolean notifyOnError){
