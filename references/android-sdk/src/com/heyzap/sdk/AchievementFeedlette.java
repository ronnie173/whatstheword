...
public class AchievementFeedlette extends Feedlette {
	...
	public View render(View convertView, final Context context,
			FeedView feedView) {
		...
		if (convertView == null) {
			...
			holder.achievementIconView = (ImageView) convertView
					.findViewById(Rzap.id("achievement_icon"));
			holder.achievementNameView = (TextView) convertView
					.findViewById(Rzap.id("achievement_name"));
			holder.achievementDescriptionView = (TextView) convertView
					.findViewById(Rzap.id("achievement_description"));
			holder.achievementNewBadgeView = (ImageView) convertView
					.findViewById(Rzap.id("new_badge_icon"));
			;
		...
		holder.achievementIconView.setImageResource(Rzap
				.drawable("icon_default_badge"));
					...
					public void onImageDownloaded(Bitmap bitmap) {
						...
						if (holder.feedlette == AchievementFeedlette.this) {
							holder.achievementIconView
									.setImageBitmap(downloadedAchievementImage);
						}
					}
				}).execute(iconUrl);
			}
	...
	// for setting ImageView to a URL. From
