...
import com.heyzap.internal.Drawables;
...
public class PreMarketCheckinDialog extends PreMarketDialog {
    ...
    View buildInfoView() {
        ...
        infoView.setBackgroundResource(Rzap.drawable("checkin_dialog_bg"));
        
        ImageView circleLogoView = new ImageView(getContext());
        circleLogoView.setBackgroundResource(Rzap.drawable("heyzap_circle"));
        ...
        peopleImageView.setImageResource(Rzap.drawable("dialog_users_ratings"));
    ...
    View buildBannerView() {
        ...
        bannerImageView.setImageResource(Rzap.drawable("dialog_banner_default"));
    ...
    protected void fireInstallClickedAnalytics() {
        Analytics.trackEvent(getContext(), "install-button-clicked");
    }

    @Override
    protected void fireSkipClickedAnalytics() {
        Analytics.trackEvent(getContext(), "skip-button-clicked");
    }
