...
public class AchievementsFullOverlay extends LeaderboardFullOverlay {
    ...
    public void launchMarket(){
        ...
        Analytics.getAnalyticsReferrer(getContext(), "action=achievements"));

        Analytics.trackEvent(getContext(), String.format("achievements-heyzap-prompt-clicked"));
    ...
    public void show(){
    	Analytics.trackEvent(getContext(), "achievements-heyzap-prompt-shown");
    	super.show();
    }
